			...
			for (i = 0; i < objlen; i++) {
				for (j = 0; j < numlen; j++) {
					if((control[i][j]) && (viewList[i][j].chart == "camera")) {
						...
						$cframe = $("<div class='camera' > <iframe src='http://192.168.0.7:8000/image.jpg' width='340px' height='170px' name ='123'></iframe></div>");
				...
				for(j=0; j<numlen; j++) {
					...
					if(viewList[i][j].chart == "video") {
						...
						$frame0 = $("<div id='size0'>"+ viewList[i][j].chartName
								...
								+ strValue1 + "&value2=" + strValue2 + "&cont1=" + strControl1
								+ "&cont2=" + strControl2 +"'><i class='fa fa-fw fa-plus''></i></a></div>"
								+"<div id='size'> <img src ='http://"+url+"/?action=stream' width='340px' height='200px'/></div>");
					...
					if(viewList[i][j].chart == "value") {
						...
						if((viewList[i][j].firstControl) != ("null" || null)) {
							$frame1 =  $("<div id='value0'>"+ viewList[i][j].chartName
									...
									+ strValue1 + "&value2=" + strValue2 + "&cont1=" + strControl1
									+ "&cont2=" + strControl2 +"'><i class='fa fa-fw fa-plus''></i></a></div>"
									+"<div id='value_btnLabel'><canvas id = 'chart" + j + "' width='165px' height='170px'/>"
							...
							$frame1 =  $("<div id='value0'>"+ viewList[i][j].chartName
										...
										+ strValue1 + "&value2=" + strValue2 + "&cont1=" + strControl1
										+ "&cont2=" + strControl2 +"'><i class='fa fa-fw fa-plus''></i></a></div>"
										+"<div id='value'><canvas id = 'chart"+j+ "' width='165px' height='200px'></canvas></div>");
							$("#chart"+j).replaceWith($frame1);
						}
					}
					if(viewList[i][j].chart == "image") {
						...
						$frame2 = $("<div id='value0'>"+ viewList[i][j].chartName
								+ "</div><div id='label_zoom'></div>"
								+"<div id='value'><img src = 'data:image/"+strValue1+";base64," +image +"' width='165px' height='200px'/></div>");
					...
					if(viewList[i][j].chart == "camera") {
						...
						$frame4 = $("<div id='size0'>"+ viewList[i][j].chartName
								...
								+ strValue1 + "&value2=" + strValue2 + "&cont1=" + strControl1
								+ "&cont2=" + strControl2 +"'><i class='fa fa-fw fa-plus''></i></a></div>"
								+"<div class='camera' id = 'draw" + j+"' width='340px' height='170px'></div>"
