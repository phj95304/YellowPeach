...
<script type="text/javascript">
	...
	function MQTTconnect() { //
		...
		console.log("connecting to " + host + " " + port+ " clientId: "+ clientId);
	...
	function chartDraw() {
		...
		if(chartChart == "bar") {
			if((chartControl1) != ("null" || null)) {
				tag = "<div class='size'><canvas id = 'drawBarChart' width='300px' height='250px'/>"
					+"<input type='button' class='button' value ='control' onclick='send_message();'/></div>";
				drawChart.innerHTML = tag;
			}
			else {
				tag = "<div class='size'><canvas id='drawBarChart' width='300px' height='250px'></canvas></div>";
				drawChart.innerHTML = tag;
			}
		}
		if(chartChart == "line") {
			if((chartControl1) != ("null" || null)) {
				tag = "<div class='size'><canvas id = 'drawLineChart' width='300px' height='250px'/></div>"
						+"<input type='button' class='button' value ='control' onclick='send_message();'/>";
				drawChart.innerHTML = tag;
			}
			else {
				tag = "<div class='size'><canvas id='drawLineChart' width='300px' height='300px'></canvas></div>";
				drawChart.innerHTML = tag;
			}
		}
		if(chartChart == "gauge") {
			if((chartControl1) != ("null" || null)) {
				tag = "<div class='size'><canvas id = 'drawGaugeChart' width='300px' height='250px'/></div>"
						+"<input type='button' class='button' value ='control' onclick='send_message();'/>";
				drawChart.innerHTML = tag;
			}
			else {
				tag = "<div class='size'><canvas id='drawGaugeChart' width='300px' height='300px'></canvas></div>";
				drawChart.innerHTML = tag;
			}
		}
		if(chartChart == "pie") {
			if((chartControl1) != ("null" || null)) {
				...
				tag = "<div class='size'><canvas id='drawPieChart' width='300px' height='250px'></canvas></div>";
				drawChart.innerHTML = tag;
			}
		}
		if(chartChart == "doughnut") {
			if((chartControl1) != ("null" || null)) {
				tag ="<div class='size'><canvas id = 'drawDoughnutChart' width='300px' height='300px'/></div>"
						+"<input type='button' class='button' value ='control' onclick='send_message();'/>";
				drawChart.innerHTML = tag;
			}
			else {
				tag = "<div class='size'><canvas id='drawDoughnutChart' width='300px' height='250px'></canvas></div>";
				drawChart.innerHTML = tag;
			}
		}
		if(chartChart == "value") {
